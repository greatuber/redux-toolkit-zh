...
If your state or actions are very large, you may want to disable the middleware as it might cause too much of a slowdown in development mode. See https://ouweiya.github.io/redux-toolkit-zh/api/getDefaultMiddleware for instructions.
